...
define(function(require,exports,module){
      ...
      var a=
          ...
          (function(t, e, i) {
              ...
              function p() { ! x && e.body && (V = !1, E = t(i), x = n(se).attr({
                  id: Y,
                  ...
                  ce = function() {
                      ...
                      function n() {
                          t(),
                              ...
                              F.html(_.get("slideshowStart")).unbind(s).one(s,
                                  function() {
                                      J.next(),
                                          i()
                                  }),
              ...
              t.colorbox || (t(p), J = t.fn[Y] = t[Y] = function(e, i) {
                  ...
                  J.position = function(e, i) {
                      function n() {
                          T[0].style.width = k[0].style.width = b[0].style.width = parseInt(x[0].style.width, 10) - j + "px",
                              b[0].style.height = C[0].style.height = H[0].style.height = parseInt(x[0].style.height, 10) - D + "px"
                      }
                      var r, h, s, l = 0,
                          d = 0,
                          c = x.offset();
                          ...
                          L.remove(),
                              ...
                              d = function() {
                                  ...
                                  $ && (o = function() {
                                      ...
                                      I.html(_.get("title")).show(), L.show(), a > 1 ? ("string" == typeof _.get("current") && R.html(_.get("current").replace("{current}", z + 1).replace("{total}", a)).show(), K[_.get("loop") || a - 1 > z ? "show": "hide"]().html(_.get("next")), P[_.get("loop") || z ? "show": "hide"]().html(_.get("previous")), ce(), _.get("preloading") && t.each([h( - 1), h(1)],
                                      function() {
                                          var i, n = W[this],
                  ...
                  J.close = function() {
                      $ && !G && (G = !0, $ = !1, u(oe), _.get("onCleanup"), E.unbind("." + Z), v.fadeTo(_.get("fadeOut") || 0, 0), x.stop().fadeTo(_.get("fadeOut") || 0, 0,
                          function() {
                              x.hide(),
                                  v.hide(),
                                  u(he),
